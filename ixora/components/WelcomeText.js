...
const WelcomeText = () => {
    return (
        ...
        >
            ...
            <motion.span variants={letterVariant} className="font-bold"> Сградата</motion.span>
            <motion.span variants={letterVariant} className="font-bold"> има</motion.span>
            <motion.span variants={letterVariant} className="font-bold"> издадено</motion.span>
            <motion.span variants={letterVariant} className="font-bold"> Удостоверение</motion.span>
            <motion.span variants={letterVariant} className="font-bold"> за</motion.span>
            <motion.span variants={letterVariant} className="font-bold"> въвеждане</motion.span>
            <motion.span variants={letterVariant} className="font-bold"> в</motion.span>
            <motion.span variants={letterVariant} className="font-bold"> експлоатация.</motion.span>
        </motion.div>
    );
};
