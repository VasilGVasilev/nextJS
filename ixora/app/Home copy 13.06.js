                    ...
                    >
                        ...
                        <div className="relative w-full h-fit overflow-hidden mx-auto z-20 group">
                            <Link href={"/gallery"}>
                                <div className="relative">
                                    <Image
                                        className="transition-transform duration-700 scale-125 ease-in-out group-hover:scale-150 blur-sm group-hover:blur-none"
                                        loader={imageLoader}
                                        src="/images-april-2025/IMG_5290.webp"
                                        width={5000}
                                        height={2813}
                                        alt="Image"
                                    />
