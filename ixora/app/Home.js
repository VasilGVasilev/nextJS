    ...
    <div>
      ...
      <div className="relative">
        <video
          ...
          preload="metadata"
        >
          <source src="/trimmed-videos/video-1.webm" type="video/webm" />
        ...
        <div className="absolute bottom-[15%] left-0 w-full h-full flex items-end justify-center ">
          ...
          >
            <motion.span variants={letterVariant}>Вашият</motion.span>
            <motion.span variants={letterVariant}> </motion.span>
            <motion.span variants={letterVariant}>луксозен</motion.span>
            <motion.span variants={letterVariant}> </motion.span>
              ...
              <Link href={"/gallery"}>
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true, amount: 0.5 }}
                  >
                    <motion.span variants={letterVariant}>Г</motion.span>
      ...
      <div ref={ref}>
        {inView && (
          <video
            ...
            preload="metadata"
          >
            <source src="/trimmed-videos/video-3.webm" type="video/webm" />
            Your browser does not support the video tag.
          </video>
        )}
      </div>
